...
export type FindCredentialQuery = { __typename?: 'Query', findCredential: { __typename?: 'Credential', uuid: string, name: string, locale: { __typename?: 'CredentialLocaleConnection', edges: Array<{ __typename?: 'CredentialLocaleEdge', node: { __typename?: 'CredentialLocale', locale: string, i18n: any } } | null> }, issuer: { __typename?: 'Issuer', uuid: string } } };
